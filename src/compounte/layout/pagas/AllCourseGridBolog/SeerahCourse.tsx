...
const seerahSteps = [
    {
        id: 1,
        title: "সীরাহ পরিচিতি",
        description: "নবীজির জীবনের সংক্ষিপ্ত পরিচিতি, সীরাহ অধ্যয়নের গুরুত্ব এবং প্রাথমিক ধারণা।",
    },
    {
        id: 2,
        title: "জন্ম ও শৈশব",
        description: "মক্কায় জন্ম, প্রাথমিক জীবন, বনি সাদ গোত্রে দুধ পান এবং আব্দুল মুত্তালিব ও আবু তালিবের তত্ত্বাবধানে বেড়ে ওঠা।",
    },
    {
        id: 3,
        title: "নবুওয়াত ও মক্কায় কার্যক্রম",
        description: "নবীজি হিসেবে নিযুক্ত হওয়ার প্রক্রিয়া, প্রথম আয়াত প্রাপ্তি, গোপন ও প্রকাশ্যে দাওয়াত এবং মক্কায় কঠিন পরিস্থিতি মোকাবিলা।",
    },
    {
        id: 4,
    ...
    {
        id: 5,
        title: "যুদ্ধ ও বিজয়সমূহ",
        description: "বদর, উহুদ এবং খন্দকের মতো গুরুত্বপূর্ণ যুদ্ধসমূহ, সন্ধি ও মক্কা বিজয়।",
    },
    {
        id: 6,
        title: "শেষ সময় ও শিক্ষা",
        description: "বিদায় হজের ভাষণ, নবীজির শেষ সময়, শিক্ষা এবং উম্মাহর জন্য গুরুত্বপূর্ণ উপদেশ ও বার্তা।",
    },
];
        ...
        <div className="min-h-screen font-sans bg-green-50 p-4 md:p-12">
            ...
            <div className="max-w-4xl mx-auto text-center mb-10 md:mb-16">
                ...
                <p className="mt-4 text-lg text-green-700">
                    আপনার প্রিয় নবী (সাঃ)-এর জীবন ও শিক্ষার সুসংগঠিত অধ্যয়ন। [Image of an open book]
                </p>
            </div>
            ...
            <div className="text-center mt-12 max-w-4xl mx-auto">
                ...
                {clickMessage && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className="mb-4 p-3 bg-green-100 text-green-800 rounded-lg font-medium"
                    >
                        {clickMessage}
                    </motion.div>
                )}
