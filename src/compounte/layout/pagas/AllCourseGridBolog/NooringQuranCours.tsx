...
import {
    SquareStack, GitMerge, Repeat2, ClipboardList, BookOpenText,
    ChevronRight, Home, Zap, User, Mail, MessageSquare, Send, Check, ExternalLink
} from 'lucide-react';

// --- ১. কোর্স মডিউল ডেটা এবং কম্পোনেন্টসমূহ ---

// Icon mapping for dynamic rendering (Using Green/Foundational icons)
const IconMap = {
    SquareStack: SquareStack,        // Foundational letters (বেসিক ভিত্তি)
    GitMerge: GitMerge,              // Joined letters (সংযুক্ত বর্ণ)
    BookOpenText: BookOpenText,      // Memorization (মুখস্থ)
    ClipboardList: ClipboardList,    // Rules (নিয়মাবলী)
    Repeat2: Repeat2,                // Practice (অনুশীলন)
};
...
const nooraniQaidaSteps: QaidaStep[] = [
    {
        id: 1,
        title: "আলিফ, বাঃ, তাঃ পরিচিতি (মৌলিক বর্ণ)",
        description: "নূরানি কায়দার প্রথম ধাপে আরবির ২৯টি স্বতন্ত্র বর্ণের সঠিক উচ্চারণ (মাখরাজ) এবং আকৃতি শেখা।",
        icon: "SquareStack",
    },
    {
        id: 2,
        title: "সংযুক্ত বর্ণ ও হরকত চর্চা",
        description: "দুই বা ততোধিক বর্ণের সংযোগ, জবর, যের, পেশ (হরকত) এবং সাকিন (জযম) এর সঠিক ব্যবহার অনুশীলন।",
        icon: "GitMerge",
    },
    {
        id: 3,
        title: "তানভীন (দুই জবর) ও মাদ (দীর্ঘতা)",
        description: "তানভীন (দুই জবর, দুই যের, দুই পেশ), মদ্দের (দীর্ঘ) অক্ষরসমূহ এবং তাশদীদ (شد) এর নিয়মাবলী নির্ভুলভাবে চর্চা।",
        icon: "BookOpenText",
    },
    {
        id: 4,
        title: "ওয়াকফ (বিরতি) ও পড়ার নিয়মাবলী",
        description: "রুকু, সিজদা, এবং আয়াত শেষ করার সময় ওয়াকফের (বিরতি) বিভিন্ন চিহ্ন ও সে অনুযায়ী পড়ার নিয়ম শেখা।",
        icon: "ClipboardList",
    },
    {
        id: 5,
        title: "নিয়মিত অনুশীলন ও পরীক্ষা",
        description: "প্রতিদিন অনুশীলনের মাধ্যমে উচ্চারণ, মাখরাজ ও তাজওয়ীদ এর প্রাথমিক চর্চা এবং নিয়মিত পরীক্ষার মাধ্যমে দক্ষতা নিশ্চিত করা।",
        icon: "Repeat2",
    },
];

// Single Step Card Component with Staggered Entrance Simulation
const StepCard: React.FC<{ step: QaidaStep, index: number }> = ({ step, index }) => {
    ...
    return (
        <div
            ...
            className={`bg-white rounded-2xl shadow-xl p-6 transition-all duration-700 ease-out 
                        hover:shadow-2xl hover:border-green-500 border-b-4 border-white cursor-pointer 
                        ${transitionClasses} 
                        hover:scale-[1.02]`}
        >
...
// --- ২. ফ্রি ট্রায়াল যোগাযোগ ফর্ম কম্পোনেন্ট (Green Theme) ---
...
const FreeTrialContactSection: React.FC = () => {
    ...
    const subject = encodeURIComponent("ফ্রি ট্রায়াল অনুরোধ (Noorani Qaida Free Trial Request)");

    const prefilledMessage = encodeURIComponent(
        `কোর্স: নূরানি কায়দা কোর্স\nনাম: ${name || "[আপনার নাম]"}\nযোগাযোগ: ${phoneOrEmail || "[মোবাইল/ইমেইল]"}\n\nমেসেজ: ${message || "[আপনার বার্তা]"}`
    );
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : "ফর্ম জমা দিতে ব্যর্থ। অনুগ্রহ করে সরাসরি যোগাযোগ করুন।";
    ...
    return (
        <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-8 transform transition-all duration-300 border-t-4 border-green-500">
            <header className="mb-6 text-center">
                <Zap className="w-8 h-8 text-green-600 mx-auto mb-3" />
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">
                    কোর্স শুরুর আগে <span className="text-green-600">ফ্রি ট্রায়ালের</span> জন্য যোগাযোগ
                </h1>
                <p className="mt-2 text-base text-gray-600">
                    আপনার সন্তানের সেরা অভিজ্ঞতা শুরু করতে নীচের ফর্ম পূরণ করুন।
                </p>
            </header>
                ...
                {submitted ? (
                    ...
                    >
                        ...
                        <button
                            ...
                            className="mt-4 inline-flex items-center text-sm font-medium text-green-600 hover:text-green-800 transition duration-150"
                        >
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="relative mt-1">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-150 pl-12"
                        ...
                        <div>
                            ...
                            <div className="relative mt-1">
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-150 pl-12 pt-3"
                        ...
                        <div className="flex flex-col gap-3 pt-2">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full inline-flex justify-center items-center bg-green-600 text-white font-semibold px-4 py-3 rounded-xl shadow-lg hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-300 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {loading ? (
...
const NooraniQaidaCourse: React.FC = () => {
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            {/* Header Section - Green Gradient Theme */}
            <div className="bg-gradient-to-br from-green-50 to-white pt-8 pb-16 shadow-inner border-b-4 border-green-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Breadcrumb */}
                    <nav className="flex text-sm text-green-600 mb-6" aria-label="Breadcrumb">
                        <a href="#" className="hover:text-green-800 flex items-center transition">
                            <Home className="w-4 h-4 mr-1" /> হোম
                        </a>
                        <ChevronRight className="w-4 h-4 mx-1.5 text-gray-400" />
                        <a href="#" className="hover:text-green-800 transition">কোর্সসমূহ</a>
                        <ChevronRight className="w-4 h-4 mx-1.5 text-gray-400" />
                        <span className="font-medium text-gray-500">নূরানি কায়দা</span>
                    </nav>

                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-green-800 text-center mb-4 leading-tight">
                        বেসিক অনলাইন নূরানি কায়দা কোর্স
                    </h1>
                    <p className="text-center text-lg md:text-xl text-green-700 font-medium max-w-4xl mx-auto">
                        শিশুদের জন্য আদর্শ! সহজ পদ্ধতিতে আরবির মৌলিক বর্ণ, হরকত ও তাজওয়ীদের প্রাথমিক ধারণা অর্জন করুন।
                    </p>
                </div>
            </div>
            ...
            <div className="py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-10 text-center border-b-2 border-green-300 pb-3">
                        কোর্স মডিউলসমূহ ও ধাপ
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
                        {nooraniQaidaSteps.map((step, index) => (
